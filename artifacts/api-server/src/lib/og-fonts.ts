...
// Playfair Display — the brand display serif used by the Studio styles (dark /
// light / gilded). Registered under a fixed family name so styleFor() can opt
// in via `displayFont` without coupling tokens to URLs. Loading failures are
